          ...
          <nav className="hidden lg:flex space-x-1 xl:space-x-2">
            {navItems.map((item) => (
              <button
                ...
                className={`flex items-center space-x-1.5 px-3 py-2 rounded-full text-sm font-medium transition-all duration-200 ${item.special
                    ? currentPage === item.id
            ...
            {user ? (
              <div className="flex items-center space-x-3">
                ...
                <button
                  ...
                  className={`flex items-center space-x-2 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${currentPage === NavPage.DASHBOARD
          ...
          <div className="p-4 space-y-1 bg-white">
            ...
            {navItems.map((item) => (
              <button
                ...
                className={`w-full flex items-center px-4 py-3.5 rounded-xl font-medium transition-all duration-200 ${currentPage === item.id
